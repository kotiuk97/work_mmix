...
<@c.page>
    ...
    <form action="/rabota/user/editUser" method="post" enctype="multipart/form-data">
        ...
        <h5 class="text-center mb-5 px-5 alert alert-primary">Edit account</h5>
        <#if user.imageName??>
            <div class="form-group row">
                <label class="col-sm-2 col-form-label">Image : </label>
                <div class="col-sm-6">
                    <img src="/img/users/${user.imageName}" style="max-height: 500px; max-width: 500px;" class="rounded" alt="no photo available">
                </div>
            </div>
        </#if>
        <div class="form-group row">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <div class="custom-file">
                    <input class="custom-file-input" type="file" name="cv" id="cv"/>
